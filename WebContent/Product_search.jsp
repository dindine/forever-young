   ...
   <hr style="margin-top: 98px; margin-bottom: 8px; border-top: 1px solid gray" >
	...
	<div id="productlist">
		<form method="post">
			...
			<h3 style="margin-bottom: 45px;">검색어 ' ${product } ' 의  결과는 ${cnt }개 있습니다.</h3>
			...
			<div id="list_content" class="row">
				<c:if test="${not empty prdouctsearchlist }">
					<c:forEach var="vo" items="${prdouctsearchlist }">
						...
						<br>
							...
							<ul id="infolist">
							<li>	<a style="text-decoration:none;" href="MyCon?type=productOne&cPage=1&p_no=${vo.p_no }&user_id=${user_id }&user_pw=${user_pw }" >
	...
	<div module="product_normalpaging" class="pagination_wrap">
      ...
      <ol class="paging">
         ...
         <c:choose>
            ...
            <c:otherwise>
               <li class="enable">
               <a href="MyCon?type=product_search&pPage=${pvo.beginPage - 1}&product_search_txt=${product }&user_id=${user_id }&user_pw=${user_pw }">&lt;</a></li>
         ...
         <c:forEach var="k" begin="${pvo.beginPage }" end="${pvo.endPage }">
            <c:choose>
               ...
               <c:otherwise>
                  <li><a href="MyCon?type=product_search&product_search_txt=${product }&pPage=${k }&user_id=${user_id }&user_pw=${user_pw }">${k }</a></li>
               </c:otherwise>
            </c:choose>
         </c:forEach>
         ...
         <c:choose>
            ...
            <c:otherwise>
               <li class="enable"><a
                  href="MyCon?type=product_search&pPage=${pvo.endPage + 1 }&product_search_txt=${product }&user_id=${user_id }&user_pw=${user_pw }">&gt;</a></li>
            </c:otherwise>
         </c:choose>
      </ol>
	</nav>
